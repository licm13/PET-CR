"""
陆地-大气框架PET估算示例 / Land-Atmosphere Framework PET Estimation Example
==============================================================================

本示例演示如何使用陆地-大气框架计算PETe和PETa。
This example demonstrates how to use the land-atmosphere framework to calculate PETe and PETa.

此方法基于Zhou & Yu (2025) Nature Climate Change论文。
This method is based on Zhou & Yu (2025) Nature Climate Change paper.
...
# 添加包路径（如果未安装）/ Add package path (if not installed)
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

import numpy as np
import matplotlib.pyplot as plt

# 导入统一的petcr包 / Import unified petcr package
from petcr import (
    calculate_pet_land,
